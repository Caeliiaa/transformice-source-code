package com.bit101.components
{
	...
	public class ScrollPane extends Panel
	{
		...
		override public function draw() : void
		{
			var _loc_2:int = NaN;
			super.draw();
			var _loc_1:Number = (_height - 10) / content.height;
			_loc_2 = (_width - 10) / content.width;
			...
			this._corner.visible = _loc_2 < 1 && _loc_1 < 1;
