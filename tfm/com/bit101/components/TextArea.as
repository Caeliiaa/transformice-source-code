package com.bit101.components
{
	...
	public class TextArea extends Text
	{
		...
		protected function updateScrollbar() : void
		{
			...
			var _loc_1:int = (_tf.numLines - _tf.maxScrollV) + 1;
			var _loc_2:Number = _loc_1 / _tf.numLines;
			this._scrollbar.setSliderParams(1, _tf.maxScrollV, _tf.scrollV);
			this._scrollbar.setThumbPercent(_loc_2);
			this._scrollbar.pageSize = _loc_1;
		}
