package com.bit101.components
{
	...
	public class ComboBox extends Component
	{
		...
		override protected function addChildren() : void
		{
			...
			this._dropDownButton = new PushButton(this, 0, 0, "v", this.onDropDown);
		}
		...
		protected function setLabelButtonLabel() : void
		{
			...
			else
			{
				...
				{
					if(this.selectedItem.hasOwnProperty("label") && this.selectedItem.label is String)
					{
		...
		protected function onDropDown(param1:MouseEvent) : void
		{
			...
			if(this._open)
			{
				...
				{
					_loc_2.y = -this._numVisibleItems * this._list.listItemHeight;
				}
				_loc_2 = localToGlobal(_loc_2);
				this._list.move(_loc_2.x, _loc_2.y);
		...
		{
			this._numVisibleItems = Math.max(1, param1);
			invalidate();
		}
