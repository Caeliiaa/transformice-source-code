package com.bit101.components
{
	...
	public class Style extends Object
	{
		...
		final public static function initialisationStyle() : void
		{
		...
		final public static function setStyle(param1:String) : void
		{
			switch(param1)
			{
			case TRANSFORMICE:
		...
		final public static function effetLumiere(param1:Sprite, param2:Boolean, param3:Boolean = false) : void
		{
			if(param2)
			{
		...
		final private static function lumiereSouris1(param1:MouseEvent) : void
		{
			var _loc_2:Sprite = param1.currentTarget;
			_loc_2.transform.colorTransform = couleurLumiere;
		}

		final private static function lumiereSouris2(param1:MouseEvent) : void
		{
			var _loc_2:Sprite = param1.currentTarget;
