package com.bit101.components
{
	...
	public class RadioButton extends Component
	{
		...
		final public static function addButton(param1:RadioButton) : void
		{
			if(buttons == null)
			{
				buttons = new Array();
		...
		final public static function clear(param1:RadioButton) : void
		{
			var _loc_2:uint = 0;
			while(_loc_2 < buttons.length)
			{
				if(!(buttons[_loc_2] == param1) && buttons[_loc_2].groupName == param1.groupName)
				{
