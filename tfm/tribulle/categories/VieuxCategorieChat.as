package tribulle.categories
{
	...
	public class VieuxCategorieChat extends Object implements V_CT_Chat
	{
		...
		{
			param1.message = param1.message.replace(new RegExp("<", "g"), "&lt;");
		...
		public function x_executeResultatMessagePrive(param1:V_ET_ResultatMessagePrive) : void
		{
			...
			{
				if(param1.erreur == V_NT_ErreurTribulle.DESTINATAIRE_INVALIDE)
				{
				...
				{
					if(param1.erreur == V_NT_ErreurTribulle.MUTE)
					{
