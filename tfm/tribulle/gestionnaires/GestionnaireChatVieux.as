package tribulle.gestionnaires
{
	...
	public class GestionnaireChatVieux extends Object
	{
		...
		final public static function getInstance() : GestionnaireChatVieux
		{
			if(_singleton == null)
			{
				_singleton = new GestionnaireChatVieux(new PrivateClass());
			}
			return _singleton;
		}

		public function GestionnaireChatVieux(param1:PrivateClass)
		{
			super();
