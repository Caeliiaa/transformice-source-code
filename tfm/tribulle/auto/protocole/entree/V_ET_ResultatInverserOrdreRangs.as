package tribulle.auto.protocole.entree
{
	...
	public class V_ET_ResultatInverserOrdreRangs extends Object implements _IPaquetEntrant, _IPaquetSequenciel
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			if(_loc_2 != null)
			{
				if(_loc_2 is V_ST_InverserOrdreRangs)
				{
					this.precedentInverserOrdreRangs = V_ST_InverserOrdreRangs(_loc_2);
