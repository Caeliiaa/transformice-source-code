package tribulle.auto.protocole.entree
{
	...
	public class V_ET_SignaleDeconnexionMembres extends Object implements _IPaquetEntrant
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			this.idMembres = new Vector<int>(_loc_2);
			var _loc_3:int = 0;
			while(_loc_3 < _loc_2)
			{
				this.idMembres[_loc_3] = param1.readInt();
				_loc_3++;
			}
		}
