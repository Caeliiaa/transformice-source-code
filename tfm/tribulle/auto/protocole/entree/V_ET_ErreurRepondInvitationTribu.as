package tribulle.auto.protocole.entree
{
	...
	public class V_ET_ErreurRepondInvitationTribu extends Object implements _IPaquetEntrant, _IPaquetSequenciel
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			if(_loc_2 != null)
			{
				if(_loc_2 is V_ST_RepondInvitationTribu)
				{
					this.precedentRepondInvitationTribu = V_ST_RepondInvitationTribu(_loc_2);
