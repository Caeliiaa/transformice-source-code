package tribulle.auto.protocole.entree
{
	...
	public class V_ET_ErreurMembresTribu extends Object implements _IPaquetEntrant, _IPaquetSequenciel
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			if(_loc_2 != null)
			{
				if(_loc_2 is V_ST_DemandeMembresTribu)
				{
					this.precedentDemandeMembresTribu = V_ST_DemandeMembresTribu(_loc_2);
