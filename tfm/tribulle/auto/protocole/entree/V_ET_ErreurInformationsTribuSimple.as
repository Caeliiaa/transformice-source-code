package tribulle.auto.protocole.entree
{
	...
	public class V_ET_ErreurInformationsTribuSimple extends Object implements _IPaquetEntrant, _IPaquetSequenciel
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			if(_loc_2 != null)
			{
				if(_loc_2 is V_ST_DemandeInformationsTribuSimpleParNom)
				{
					this.precedentDemandeInformationsTribuSimpleParNom = V_ST_DemandeInformationsTribuSimpleParNom(_loc_2);
