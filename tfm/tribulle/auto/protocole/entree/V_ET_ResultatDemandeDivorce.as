package tribulle.auto.protocole.entree
{
	...
	public class V_ET_ResultatDemandeDivorce extends Object implements _IPaquetEntrant, _IPaquetSequenciel
	{
		...
		public function lecture(param1:ByteArray) : void
		{
			...
			if(_loc_2 != null)
			{
				if(_loc_2 is V_ST_DemandeDivorce)
				{
					this.precedentDemandeDivorce = V_ST_DemandeDivorce(_loc_2);
