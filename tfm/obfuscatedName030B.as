package 
{
	...
	public class obfuscatedName030B extends obfuscatedName0185
	{
		public var obfuscatedName29E2:Vector.<obfuscatedName0574>;

		public function obfuscatedName030B(param1:ByteArray)
		{
			...
			while(_loc_3 < _loc_2)
			{
				...
				_loc_4.obfuscatedName203B = param1.readInt() / obfuscatedName0580.obfuscatedName3DB6;
